...
const RegistrationForm = () => {
  ...
  //       value={email}
  //       onChange={handleEmailChange}
  //       className="block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1  text-black  hover:bg-slate-200"
  //       placeholder="Email Address"
  //     />
  //     <label htmlFor="password" className="sr-only">
  //       Password
  ...
  //       autoComplete="current-password"
  //       required=""
  //       className="mt-2 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1 text-black  hover:bg-slate-200"
  //       placeholder="Password"
  //       value={password}
  //       onChange={handlePasswordChange}
  //     />
