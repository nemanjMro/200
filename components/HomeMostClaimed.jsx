...
function HomeMostClaimed() {
  ...
  return (
    <div className='w-5/6 m-auto rounded-[50px] m-auto mt-16 text-center'>
        ...
        <p className='font-semibold w-2/4 m-auto my-10 text-[17px]'>Not found anything you fancy yet? Here is a collection of the most used casino bonus codes based on our daily visitor stats.</p>
        <div>
