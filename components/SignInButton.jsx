...
import { Menu, Transition, Items, Item, Button } from "@headlessui/react";
    ...
    <>
      {session ? (
        <Menu as="div" className="relative">
          ...
          >
            <Items className="bg-react dark:text-react absolute right-0 mt-1 flex w-96 origin-top-right flex-col rounded-xl py-6 text-white shadow-lg focus:outline-none dark:bg-white">
