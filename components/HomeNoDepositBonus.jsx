...
function HomeNoDepositBonus() {
  return (
    <div className='w-5/6 h-[800px] bg-[#9D3FF6] m-auto mt-24 rounded-[30px] p-24 text-[#FFFFFF]'>
        ...
        <div className='text-left text-[#2B0054] font-medium flex justify-between p-5 items-center m-auto rounded-[10px] bg-white mb-5'>
                <div className='w-2/6'>
